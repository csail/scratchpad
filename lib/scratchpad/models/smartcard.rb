...
class Smartcard
  ...
  def initialize(attributes = nil)
    if attributes
      ...
      @leaf_count = attributes[:leaf_count]
  ...
  #
  # Args:
  #   nonce:: a nonce generated by the FPGA's boot-up process.
  #
  ...
  def bind_to_fpga(encrypted_fpga_key, root_hash, leaf_count)
    ...
    @fpga_key = Crypto.pki_decrypt @endorsement_key[:private], encrypted_fpga_key
    @root_hash = root_hash
  end
